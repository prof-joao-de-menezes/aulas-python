class Carro:
    def __init__(self, dono, cor, tipo, modelo, ano, fabricante):
        ...
        self.tipo = tipo
        self.__modelo = modelo # _Carro__modelo
        self.ano = ano
...
carro_victor = Carro("Victor",
                     ...
                     "GM")
print(carro_victor)
carro_victor.modelo = "Ferrari"
carro_victor.__modelo = "Ferrari"
carro_victor._Carro__modelo = "Ferrari"
print(carro_victor)
#imprime até o name mangling -> PRIVADO
# __modelo
# _Carro_modelo
print(carro_victor.__dict__)